...
export const selectServicesIds = (state: RootState) =>
    state.serviceToggle.selectedServicesIds;
...
export const selectIsServiceSelected = (serviceId: number) =>
    createSelector([selectServicesIds], (selectedIds) =>
